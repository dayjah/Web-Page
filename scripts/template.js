...
var data = {
    aboutMe: [{
          ...
          desc: 'I recently discovered my interests in 
          front - end development.I love a
          well designed UI / UX,
          and I love it
          more when I was the one behind it.
          '
          }, {
          title: 'Musician',
          subTitle: 'I enjoy both listening, and playing',
          desc: 'Now I will admit I am no musical genius,
          yet I love listening to /
          playing music.Currently trying
          to learn how to play the bass.
          '
          }, {
          title: 'Gamer',
          subTitle: 'I fancy playing a game or two',
          desc: 'I like to game occasionally, most
          people say that this is a waste of
          time.I disagree,
          in some cases
          can teach leadership / team work.
          '
          }, {
          title: 'To the Future',
          subTitle: 'My Goals to meet',
          desc: 'Future plans include increasing
          my knowledge in the web
          development field.Also I have
          many projects that I would love
          to create!'
    }],
    skills: [{
            title: 'HTML',
...
$("#aboutMe").html(template(data.aboutMe));

$("#skills").html(template(data.aboutMe));

$("#social").html(template(data.aboutMe));
